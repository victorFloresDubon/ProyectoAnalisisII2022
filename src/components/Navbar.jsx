    ...
    return (
        <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
            ...
            <ul className={!nav ? 'hidden md:hidden' : "absolute bg-zinc-200 w-full px-8"}>
                ...
                <li className='border-b-2 border-zinc-300 w-full flex justify-center items-center'>
                    <FcGlobe className='w-10' />
                    <Link onClick={handleClose} to="" smooth={true} offset={-200} duration={500}>
                        Países
                    </Link>
                </li>
                <li className='border-b-2 border-zinc-300 w-full flex justify-center items-center'>
                    <HiUserGroup className='w-10' />
                    <Link onClick={handleClose} to="" smooth={true} offset={-50} duration={500}>
                        Grupos
                    </Link>
                </li>
                <li className='border-b-2 border-zinc-300 w-full flex justify-center items-center'>
                    <HiOutlineOfficeBuilding className='w-10' />
                    <Link onClick={handleClose} to="" smooth={true} offset={-100} duration={500}>
                        Estadios
                    </Link>
                </li>
                <li className='border-b-2 border-zinc-300 w-full flex justify-center items-center'>
                ...
                <div className="flex flex-col my-4">
                    <button className="bg-transparent text-black px-8 py-3 mb-4 hover:bg-transparent hover:text-black flex justify-center items-center">
                        Login
